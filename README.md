# [full stack apache2 Symfony for everyone with docker compose](https://github.com/damalis/full-stack-apache2-symfony-for-everyone-with-docker-compose)

If You want to build a website with Symfony "webapp" at short time; 

#### Full stack Apache2 Symfony "webapp":
...
- [Symfony](https://github.com/symfony4/symfony4) - [php-fpm](https://hub.docker.com/_/php?tab=tags&page=1&name=fpm)
...
```
git clone https://github.com/damalis/full-stack-apache2-symfony-for-everyone-with-docker-compose.git
```
